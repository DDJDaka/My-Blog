...
const IndexScreen = ({ navigation }) => {
    ...
    return (
        <View>
            <Text style={{ textAlign: "center", fontSize: 22, marginVertical: 15 }}>Index Screen</Text>
            {state.length === 0
                ? <Text style={{ textAlign: "center", fontSize: 16, color: "grey" }}>Click the '+' icon to create a new Blogpost</Text>
                :
                <FlatList
                    data={state}
